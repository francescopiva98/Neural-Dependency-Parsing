# Neural Dependency Parsing @Unipd
...
## 🎯Aim
The aim was to investigate how different neural architectures influence parsing performance when integrated into a transition‑based framework.
